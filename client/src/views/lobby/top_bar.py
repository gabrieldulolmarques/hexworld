...
from views.shared.layout_utils import relayout_after_content_change
from views.shared.ui_buttons import make_toolbar_button
...
class TopBar(QWidget):
    ...
    def set_user(self, username: str) -> None:
        ...
        elided = metrics.elidedText(
            username, Qt.TextElideMode.ElideRight, _BADGE_MAX_PX
        )
