...
class _ControlButton(QPushButton):
    ...
    def paintEvent(self, event: QPaintEvent) -> None:
        ...
        bg = (
            ...
            else self.BG_HOVER if hovered else self.BG_NORMAL
        )
        if hovered and is_close:
        ...
        if self._kind == "min":
            ...
            front = (int(cx - s - offset), int(cy - s + offset), int(s * 2), int(s * 2))
...
class WindowTitleBar(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self.minimize_button = _ControlButton("min")
        self.maximize_button = _ControlButton("max")
        self.close_button = _ControlButton("close")
