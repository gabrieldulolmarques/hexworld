...
class MapLifecycleController:
    ...
    def handle_create_map(self, request: dict, connection: object, auth: dict) -> dict:
    ...
    def handle_join_map(self, request: dict, connection: object, auth: dict) -> dict:
    ...
    def handle_get_maps(self, request: dict, connection: object, auth: dict) -> dict:
    ...
    def handle_delete_map(self, request: dict, connection: object, auth: dict) -> dict:
        map_id = (request.get("data") or {}).get("map_id", "")
    ...
    def handle_close_map(self, request: dict, connection: object, auth: dict) -> dict:
        map_id = (request.get("data") or {}).get("map_id", "")
        if not map_id:
